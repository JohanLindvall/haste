...
// no constant pool, where three paired loads from here cost three. It is
// never written. The x86 kernels use immediates, which are one instruction
// there.
var primes = [5]uint64{prime1, prime2, prime3, prime4, prime5}
