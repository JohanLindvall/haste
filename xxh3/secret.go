...
const secretDefaultSize = 192

// kSecret is the default secret: 192 bytes of high-entropy material that keys
// every XXH3 variant. It is a fixed part of the algorithm, so it must match the
// reference byte for byte or no output will.
var kSecret = [secretDefaultSize]byte{
